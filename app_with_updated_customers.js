...
function loadTasks() {
    ...
    const tasks = [
        { id: 1, klant: "Muhammed Bolat", adres: "Willem Kloosstraat 27, Almelo", contact: "0621527392", email: "muhammed.bolat@gmail.com" },
        { id: 2, klant: "Adem Bolat", adres: "Gerard Doustraat 1, Almelo", contact: "0621264655", email: "bolat_adem@yahoo.com" },
        { id: 3, klant: "Beyazit Bolat", adres: "Willem Kloosstraat 46, Almelo", contact: "0616415140", email: "beyazit.bolat@gmail.com" }
    ];
...
function generateAfmetingenInputs() {
    ...
    return ruimtes.map((ruimte, index) => `
        ...
        <input type="number" id="length-${index}" placeholder="Lengte (m)" style="width: 80px;" oninput="calculateArea(${index})">
        <input type="number" id="width-${index}" placeholder="Breedte (m)" style="width: 80px;" oninput="calculateArea(${index})">
