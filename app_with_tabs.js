document.addEventListener("DOMContentLoaded", function () {
    ...
    const tasks = [
        { id: 1, klant: "Jansen BV", adres: "Fazantstraat 22, Borne", contact: "Jan de Vries", prijs: "€250", artikel: "TAPIJT SILVERTON TAUPE", werkzaamheden: "Leggen van tapijt", afmetingen: "400cm x 300cm" },
        { id: 2, klant: "Bakkerij De Groot", adres: "Hooi-esch 26, Delden", contact: "Petra Bakker", prijs: "€180", artikel: "Vloercoating", werkzaamheden: "Aanbrengen van coating", afmetingen: "500cm x 400cm" },
        { id: 3, klant: "Tech Solutions", adres: "Spanbeddestraat 41, Haaksbergen", contact: "Mark Jansen", prijs: "€320", artikel: "Laminaat Eiken", werkzaamheden: "Leggen van laminaat", afmetingen: "600cm x 350cm" }
    ];
...
function openTask(taskId) {
    ...
    document.body.innerHTML = `
        ...
        <br><br>
        <button onclick="sendPDF(${taskId})">Opdracht Afronden & PDF Versturen</button>
    `;
...
function sendPDF(taskId) {
    alert("PDF wordt gegenereerd en verzonden voor opdracht " + taskId);
}
